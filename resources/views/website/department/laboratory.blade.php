...
@section('content')
    ...
    <div class="container pt-4 mb-5">
        ...
        @if(isset($laboratories) && $laboratories->count() > 0)
            @foreach ($laboratories as $laboratory)
                <div class="row">
                    ...
                    <div class="col-lg-4" data-aos="fade-left" data-aos-delay="400">
                        <p>{{ $laboratory->info }}</p>
                        <a href="{{ $laboratory->link }}" target="_blank" class="btn btn-primary bgColorbtn rounded-0 px-2">Click Here</a>
                    </div>
                </div>
            @endforeach
        @else
            <div class="row">
                <div class="col-12 text-center">
                    <p class="text-muted">No laboratory information available at the moment.</p>
                </div>
            </div>
        @endif
    </div>
